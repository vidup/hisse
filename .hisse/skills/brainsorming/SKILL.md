...
| ------------------------- | ---------------------------------------------------- |
| **5 Whys**                | Problème à résoudre, chercher la cause racine        |
| **SCAMPER**               | Idée claire, besoin de variations créatives          |
| **Mind Mapping**          | Beaucoup d'idées en vrac, besoin de structure        |
| **Reverse Brainstorming** | Valider/challenger une idée, anticiper les problèmes |
| **Six Thinking Hats**     | Décision complexe, analyse multi-angle               |
| **Starbursting**          | Idée vague, besoin de cadrer avec les 6 questions    |
| **SWOT**                  | Évaluation stratégique, viabilité                    |
