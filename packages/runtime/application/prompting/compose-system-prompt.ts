...
export function composeSystemPrompt(params: ComposeSystemPromptParams): string {
  ...
  const sections = [
    ...
    [
      ...
      "AskUserQuestions supports yes_no, single_select, multi_select, and scale questions, with a maximum of 6 questions per bundle.",
      "Scale questions require a numeric range with min and max values, and can optionally define step, unit, and labeled marks.",
